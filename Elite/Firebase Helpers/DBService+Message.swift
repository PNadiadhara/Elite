...
extension DBService {
    ...
    static public func postMultipleInvitations(invitations: [Invitation], completion: @escaping (Error?, String?) -> Void)  {
    ...
    static public func deleteMultipleInvitations(invitations: [Invitation], completion: @escaping(Error?) -> Void) {
        for invitation in invitations {
            DBService.firestoreDB
                .collection(InvitationCollectionKeys.collectionKey)
                .document(invitation.invitationId)
    ...
    static func fetchGameInvitations(gameId: String, completion: @escaping(Error?, [Invitation]?) -> Void) {
        let query = firestoreDB.collection(InvitationCollectionKeys.collectionKey).whereField(InvitationCollectionKeys.gameIdKey, isEqualTo: gameId)
